...
<div class="col-12 col-xl-12">
    <div class="col mt-4">
        ...
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addConversionRecordModal">
    Add New
</button>
        <div class="row">
        <div class="col">
        ...
        <tbody>
            <?php foreach ($conversionData as $conversionRecord) { ?>
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editConversionModal<?php echo $conversionRecord['id']; ?>">
                        <i class="fas fa-edit"></i>
                        </button>
                        <a href="conversion_information.php?id=<?php echo $conversionRecord['id']; ?>" class="btn btn-warning"><i class="fas fa-eye"></i></a>
                        <script>
...
?>
    ...
    <div class="modal fade" id="editConversionModal<?= $conversion['id'] ?>" tabindex="-1" aria-labelledby="editConversionModalLabel<?= $conversion['id'] ?>" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bolder" id="editConversionModalLabel<?= $conversion['id'] ?>">Edit Conversion Record</h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="<?= $conversion['name'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="date_of_rite" class="form-label">Date of Rite:</label>
                                    <input type="date" class="form-control" id="date_of_rite" name="date_of_rite" value="<?= $conversion['date_of_rite'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="date_of_birth" class="form-label">Date of Birth:</label>
                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="<?= $conversion['date_of_birth'] ?>" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="record_no" name="record_no" value="<?= $conversion['record_no'] ?>" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="place_of_birth" class="form-label">Place of Birth:</label>
                                    <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" value="<?= $conversion['place_of_birth'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="name_of_mother" class="form-label">Name of Mother:</label>
                                    <input type="text" class="form-control" id="name_of_mother" name="name_of_mother" value="<?= $conversion['name_of_mother'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                                    <label for="name_of_father" class="form-label">Name of Father:</label>
                                    <input type="text" class="form-control" id="name_of_father" name="name_of_father" value="<?= $conversion['name_of_father'] ?>" required>
                                </div>
                        <div class="mb-3">
                            <label for="receiving_minister" class="form-label">Receiving Priest:</label>
                            <input type="text" class="form-control" id="receiving_minister" name="receiving_minister" value="<?= $conversion['receiving_minister'] ?>" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="date_of_baptism" class="form-label">Date of Baptism:</label>
                                    <input type="date" class="form-control" id="date_of_baptism" name="date_of_baptism" value="<?= $conversion['date_of_baptism'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="place_of_baptism" class="form-label">Place of Baptism:</label>
                                    <input type="text" class="form-control" id="place_of_baptism" name="place_of_baptism" value="<?= $conversion['place_of_baptism'] ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="denomination" class="form-label">Denomination:</label>
                            <input type="text" class="form-control" id="denomination" name="denomination" value="<?= $conversion['denomination'] ?>" required>
                        </div>
...
<div class="modal fade" id="addConversionRecordModal" tabindex="-1" aria-labelledby="addConversionRecordModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg">
    ...
    <input type="text" class="form-control" id="record_no" name="record_no" required>
                    ...
                    <div class="mb-3">
                        <label for="receiving_minister" class="form-label">Receiving Priest:</label>
                        <input type="text" class="form-control" id="receiving_minister" name="receiving_minister" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
