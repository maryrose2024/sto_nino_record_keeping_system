                                ...
                                <tbody>
                                    <?php foreach ($adminData as $admin) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editadminModal<?php echo $admin['id']; ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <a href="account_delete.php?id=<?php echo $admin['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
